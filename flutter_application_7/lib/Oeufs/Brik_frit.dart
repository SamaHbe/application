...
class BrikFrit extends StatefulWidget {
  @override
  State<StatefulWidget> createState() => BrikFritState();
}

class BrikFritState extends State<BrikFrit> {
  ...
  String name = "Brik frit(oeuf, thon, pomme de terre)";
  @override
