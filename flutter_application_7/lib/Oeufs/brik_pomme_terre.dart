...
class BrikPommeTerre extends StatefulWidget {
  @override
  State<StatefulWidget> createState() => BrikPommeTerreState();
}

class BrikPommeTerreState extends State<BrikPommeTerre> {
  ...
  String name = "Brik à la pomme de terre";
  @override
