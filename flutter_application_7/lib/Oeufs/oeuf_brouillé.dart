...
class OeufBrouille extends StatefulWidget {
  @override
  State<StatefulWidget> createState() => OeufBrouilleState();
}

class OeufBrouilleState extends State<OeufBrouille> {
  ...
  String name = "Oeuf brouillé au beure";
  @override
