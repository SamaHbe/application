...
class OeufEnOmelette extends StatefulWidget {
  @override
  State<StatefulWidget> createState() => OeufEnOmeletteState();
}

class OeufEnOmeletteState extends State<OeufEnOmelette> {
