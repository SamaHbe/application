...
class OeufMayonnaise extends StatefulWidget {
  @override
  State<StatefulWidget> createState() => OeufMayonnaiseState();
}

class OeufMayonnaiseState extends State<OeufMayonnaise> {
  ...
  String name = "Oeuf à la moyonnaise";
  @override
