...
class OeufFromage extends StatefulWidget {
  @override
  State<StatefulWidget> createState() => OeufFromageState();
}

class OeufFromageState extends State<OeufFromage> {
  ...
  String name = "Omelette au fromage ou thon ";
  @override
