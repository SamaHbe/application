...
class Baguette extends StatefulWidget {
  @override
  State<StatefulWidget> createState() => BaguetteState();
}

class BaguetteState extends State<Baguette> {
