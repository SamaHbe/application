...
class CerealesBle extends StatefulWidget {
  @override
  State<StatefulWidget> createState() => CerealesBleState();
}

class CerealesBleState extends State<CerealesBle> {
  ...
  String name = "Céréales au son de blé";
  @override
