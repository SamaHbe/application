...
class Cerealessecs extends StatefulWidget {
  @override
  State<StatefulWidget> createState() => CerealessecsState();
}

class CerealessecsState extends State<Cerealessecs> {
  ...
  String name = "Céréales aux fruits secs";
  @override
