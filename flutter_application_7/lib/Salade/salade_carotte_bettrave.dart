...
class SaladeCarotte extends StatefulWidget {
  @override
  State<StatefulWidget> createState() => SaladeCarotteState();
}

class SaladeCarotteState extends State<SaladeCarotte> {
  ...
  String name = "Salade carotte ou betterave à l'huile";
  @override
