...
class SaladeCoeur extends StatefulWidget {
  @override
  State<StatefulWidget> createState() => SaladeCoeurState();
}

class SaladeCoeurState extends State<SaladeCoeur> {
  ...
  String name = "Salade coeur d'artichaut vinaigrette";
  @override
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text(
          "$name ",
          style:
              TextStyle(fontSize: 14, color: Color.fromARGB(255, 252, 116, 25)),
        ),
      ),
