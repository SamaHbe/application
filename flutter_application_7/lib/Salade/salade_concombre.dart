...
class SaladeConcombre extends StatefulWidget {
  @override
  State<StatefulWidget> createState() => SaladeConcombreState();
}

class SaladeConcombreState extends State<SaladeConcombre> {
  ...
  String name = "Salade concombre+oignion ou fenouil vinaigrette ";
  @override
