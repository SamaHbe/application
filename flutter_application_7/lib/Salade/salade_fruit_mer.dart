...
class SaladeFruitMer extends StatefulWidget {
  @override
  State<StatefulWidget> createState() => SaladeFruitMerState();
}

class SaladeFruitMerState extends State<SaladeFruitMer> {
  ...
  String name = "Salade de fruit de mer";
  @override
