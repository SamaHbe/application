...
class SaladeHaricot extends StatefulWidget {
  @override
  State<StatefulWidget> createState() => SaladeHaricotState();
}

class SaladeHaricotState extends State<SaladeHaricot> {
  ...
  String name = "Salade haricot vert vinaigrette";
  @override
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text(
          "$name ",
          style:
              TextStyle(fontSize: 12, color: Color.fromARGB(255, 252, 116, 25)),
        ),
      ),
