...
class SaladeLentielles extends StatefulWidget {
  @override
  State<StatefulWidget> createState() => SaladeLentiellesState();
}

class SaladeLentiellesState extends State<SaladeLentielles> {
  ...
  String name = "Salade de lentilles vinaigrette";
  @override
