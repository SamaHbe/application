...
class SaladeNicoise extends StatefulWidget {
  @override
  State<StatefulWidget> createState() => SaladeNicoiseState();
}

class SaladeNicoiseState extends State<SaladeNicoise> {
  ...
  String name = "Salade niçoise vinaigrette ";
  @override
