...
class SaladePommeTerre extends StatefulWidget {
  @override
  State<StatefulWidget> createState() => SaladePommeTerreState();
}

class SaladePommeTerreState extends State<SaladePommeTerre> {
  ...
  String name = "Salade de pomme de terre vignairette ";
  @override
