...
class SaladeRizThon extends StatefulWidget {
  @override
  State<StatefulWidget> createState() => SaladeRizThonState();
}

class SaladeRizThonState extends State<SaladeRizThon> {
  ...
  String name = "Salade de riz au thon ";
  @override
