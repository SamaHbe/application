...
class SaladeRusse extends StatefulWidget {
  @override
  State<StatefulWidget> createState() => SaladeRusseState();
}

class SaladeRusseState extends State<SaladeRusse> {
  ...
  String name = "Salade Russe vignairette";
  @override
