...
class SaladeTomate extends StatefulWidget {
  @override
  State<StatefulWidget> createState() => SaladeTomateState();
}

class SaladeTomateState extends State<SaladeTomate> {
  ...
  String name = "Salade de tomate vinaigrette";
  @override
