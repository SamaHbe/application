...
class SaladeTunisienne extends StatefulWidget {
  @override
  State<StatefulWidget> createState() => SaladeTunisienneState();
}

class SaladeTunisienneState extends State<SaladeTunisienne> {
  ...
  String name = "Salade tunisienne vinaigrette                    ";
  @override
