...
class Aromatisees extends StatefulWidget {
  @override
  State<StatefulWidget> createState() => AromatiseesState();
}

class AromatiseesState extends State<Aromatisees> {
  ...
  String name = "Eaux plates,gazeuses aromatisées peu sucrés";
  @override
