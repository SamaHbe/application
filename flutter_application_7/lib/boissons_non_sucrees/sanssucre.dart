...
class Sanssucre extends StatefulWidget {
  @override
  State<StatefulWidget> createState() => SanssucreState();
}

class SanssucreState extends State<Sanssucre> {
  ...
  String name = "Eaux plates,gazeuses aromatisées sans sucrés";
  @override
