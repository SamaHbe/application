...
class Jusfruits extends StatefulWidget {
  @override
  State<StatefulWidget> createState() => JusfruitsState();
}

class JusfruitsState extends State<Jusfruits> {
  ...
  String name = "Jus de fruits sans sucre ajouté";
  @override
