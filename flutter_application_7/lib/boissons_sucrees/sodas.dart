...
class Sodas extends StatefulWidget {
  @override
  State<StatefulWidget> createState() => SodasState();
}

class SodasState extends State<Sodas> {
  ...
  String name = "Sodas, cola, boisson aux fruits";
  @override
