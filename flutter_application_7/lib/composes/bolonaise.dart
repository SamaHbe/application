...
class Bolonaise extends StatefulWidget {
  @override
  State<StatefulWidget> createState() => BolonaiseState();
}

class BolonaiseState extends State<Bolonaise> {
  ...
  String name = "Spaghetti bolonaise aldente";
  @override
