...
class Couscousl extends StatefulWidget {
  @override
  State<StatefulWidget> createState() => CouscouslState();
}

class CouscouslState extends State<Couscousl> {
  ...
  String name = " Couscous aux légumes ";
  @override
