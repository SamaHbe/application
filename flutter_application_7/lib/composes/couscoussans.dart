...
class Couscoussans extends StatefulWidget {
  @override
  State<StatefulWidget> createState() => CouscoussansState();
}

class CouscoussansState extends State<Couscoussans> {
  ...
  String name = " Couscous sans légumes ";
  @override
