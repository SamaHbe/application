...
class Riz extends StatefulWidget {
  @override
  State<StatefulWidget> createState() => RizState();
}

class RizState extends State<Riz> {
  ...
  String name = " Riz, riz complet en sauce";
  @override
