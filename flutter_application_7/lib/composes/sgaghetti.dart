...
class Sgaghetti extends StatefulWidget {
  @override
  State<StatefulWidget> createState() => SgaghettiState();
}

class SgaghettiState extends State<Sgaghetti> {
  ...
  String name = "Spaghetti aux fruitsde mer aldente";
  @override
