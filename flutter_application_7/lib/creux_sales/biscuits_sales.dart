...
class BiscuitsSales extends StatefulWidget {
  @override
  State<StatefulWidget> createState() => BiscuitsSalesState();
}

class BiscuitsSalesState extends State<BiscuitsSales> {
  ...
  String name = "Biscuits apéritifs salés";
  @override
