...
class BarreChocolat extends StatefulWidget {
  @override
  State<StatefulWidget> createState() => BarreChocolatState();
}

class BarreChocolatState extends State<BarreChocolat> {
