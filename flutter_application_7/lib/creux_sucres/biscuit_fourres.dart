...
class BiscuitFourres extends StatefulWidget {
  @override
  State<StatefulWidget> createState() => BiscuitFourresState();
}

class BiscuitFourresState extends State<BiscuitFourres> {
                    ...
                    child: Column(
                      children: [
                        ...
                        CircularPercentIndicator(
                          ...
                          center: Text("${lipides.toStringAsFixed(0)}",
                              style: TextStyle(
                                  color: Color.fromARGB(255, 252, 116, 25),
                                  fontSize: 20)),
                        ),
