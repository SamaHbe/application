...
class Chocolats extends StatefulWidget {
  @override
  State<StatefulWidget> createState() => ChocolatsState();
}

class ChocolatsState extends State<Chocolats> {
  ...
  String name = "Chocolats noir, au lait, blanc";
  @override
