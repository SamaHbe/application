...
class PetitBeurre extends StatefulWidget {
  @override
  State<StatefulWidget> createState() => PetitBeurreState();
}

class PetitBeurreState extends State<PetitBeurre> {
