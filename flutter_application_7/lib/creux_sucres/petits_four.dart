...
class PetitsFour extends StatefulWidget {
  @override
  State<StatefulWidget> createState() => PetitsFourState();
}

class PetitsFourState extends State<PetitsFour> {
  ...
  String name = "Petits-four sucrés";
  @override
