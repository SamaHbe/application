...
class Ramequin extends StatefulWidget {
  @override
  State<StatefulWidget> createState() => RamequinState();
}

class RamequinState extends State<Ramequin> {
  ...
  String name = "Ramequin de salade de fruits";
  @override
