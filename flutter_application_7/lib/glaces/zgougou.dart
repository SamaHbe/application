...
class Zgougou extends StatefulWidget {
  @override
  State<StatefulWidget> createState() => ZgougouState();
}

class ZgougouState extends State<Zgougou> {
  ...
  String name = "Assida zgougou décorée";
  @override
