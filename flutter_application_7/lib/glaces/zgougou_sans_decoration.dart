...
class zgougousd extends StatefulWidget {
  @override
  State<StatefulWidget> createState() => zgougousdState();
}

class zgougousdState extends State<zgougousd> {
  ...
  String name = "Assida zgougou sans décoration";
  @override
