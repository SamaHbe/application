...
class Makroudh extends StatefulWidget {
  @override
  State<StatefulWidget> createState() => MakroudhState();
}

class MakroudhState extends State<Makroudh> {
  ...
  String name = "Makroudh de Kairouan";
  @override
