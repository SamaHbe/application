...
class CrepeThonFromage extends StatefulWidget {
  @override
  State<StatefulWidget> createState() => CrepeThonFromageState();
}

class CrepeThonFromageState extends State<CrepeThonFromage> {
  ...
  String name = "Crêpe thon/fromage";
  @override
