...
class Pate extends StatefulWidget {
  @override
  State<StatefulWidget> createState() => PateState();
}

class PateState extends State<Pate> {
  ...
  String name = "Pâté au fromage ou poulet ou thon";
  @override
