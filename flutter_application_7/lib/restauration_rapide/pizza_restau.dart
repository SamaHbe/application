...
class PizzaRestau extends StatefulWidget {
  @override
  State<StatefulWidget> createState() => PizzaRestauState();
}

class PizzaRestauState extends State<PizzaRestau> {
  ...
  String name = "Pizza de restaurant";
  @override
