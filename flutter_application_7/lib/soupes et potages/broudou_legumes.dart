...
class BroudouLegumes extends StatefulWidget {
  @override
  State<StatefulWidget> createState() => BroudouLegumesState();
}

class BroudouLegumesState extends State<BroudouLegumes> {
  ...
  String name = "Broudou légumes sans huile";
  @override
