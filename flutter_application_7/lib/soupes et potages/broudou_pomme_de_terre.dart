...
class BroudouPomme extends StatefulWidget {
  @override
  State<StatefulWidget> createState() => BroudouPommeState();
}

class BroudouPommeState extends State<BroudouPomme> {
  ...
  String name = "Broudou à la pomme de terre sans huile";
  @override
