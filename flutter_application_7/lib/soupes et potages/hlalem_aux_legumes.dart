...
class Hlalem extends StatefulWidget {
  @override
  State<StatefulWidget> createState() => HlalemState();
}

class HlalemState extends State<Hlalem> {
  ...
  String name = "Hlalem aux légumes";
  @override
