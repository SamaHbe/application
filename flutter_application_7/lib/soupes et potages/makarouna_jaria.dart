...
class MakrounaJaria extends StatefulWidget {
  @override
  State<StatefulWidget> createState() => MakrounaJariaState();
}

class MakrounaJariaState extends State<MakrounaJaria> {
  ...
  String name = "Makrouna jaria (légumes)";
  @override
