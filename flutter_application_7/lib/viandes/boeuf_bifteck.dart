...
class BoeufBifteck extends StatefulWidget {
  @override
  State<StatefulWidget> createState() => BoeufBifteckState();
}

class BoeufBifteckState extends State<BoeufBifteck> {
  ...
  String name = "Boeuf bifteck grillé";
  @override
