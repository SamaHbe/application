...
class BoeufEntrecote extends StatefulWidget {
  @override
  State<StatefulWidget> createState() => BoeufEntrecoteState();
}

class BoeufEntrecoteState extends State<BoeufEntrecote> {
  ...
  String name = "Boeuf entrecote grillé";
  @override
