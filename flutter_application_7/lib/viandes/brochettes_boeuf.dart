...
class BoulettesBoeuf extends StatefulWidget {
  @override
  State<StatefulWidget> createState() => BoulettesBoeufState();
}

class BoulettesBoeufState extends State<BoulettesBoeuf> {
  ...
  String name = "Boulettes de boeuf";
  @override
