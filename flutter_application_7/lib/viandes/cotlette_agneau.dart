...
class CotlettesAgneau extends StatefulWidget {
  @override
  State<StatefulWidget> createState() => CotlettesAgneauState();
}

class CotlettesAgneauState extends State<CotlettesAgneau> {
  ...
  String name = "Cotlettees d'agneau grillées";
  @override
