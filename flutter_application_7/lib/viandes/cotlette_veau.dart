...
class CotlettesVeau extends StatefulWidget {
  @override
  State<StatefulWidget> createState() => CotlettesVeauState();
}

class CotlettesVeauState extends State<CotlettesVeau> {
  ...
  String name = "Cotlettees de veau grillées";
  @override
