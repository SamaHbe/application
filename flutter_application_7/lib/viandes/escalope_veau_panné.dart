...
class EscalopeVeau extends StatefulWidget {
  @override
  State<StatefulWidget> createState() => EscalopeVeauState();
}

class EscalopeVeauState extends State<EscalopeVeau> {
  ...
  String name = "Escalope de veau pané";
  @override
